...
const Register = () => {
  ...
  return (
    <div>
      ...
      <div className="py-12">
        <div className="custom-login lg:w-3/4 w-full mx-auto px-6 py-8 mt-12">
              ...
              <div className="hero-content w-11/12 mx-auto">
                <div className="card w-full">
                  ...
                  >
                    ...
                    <div className="form-control gap-2">
                      <label className="">
                        <span className="l font-semibold">
                          Enter Your Email
                        </span>
                      </label>
                      <input
                    ...
                    <div className="flex lg:flex-row flex-col justify-between items-center mt-6 gap-4">
                      <div className="w-full">
                        <select
                          ...
                          className="select select-bordered w-full rounded-full font-semibold custom-select border-gray-400 border-[1px]"
                        >
                      ...
                      <div className="w-full">
                        <input
                          ...
                          type="file"
                          className="file-input file-input-bordered file-input-info w-full text-center rounded-full custom-select"
                        />
                      </div>
                    </div>
