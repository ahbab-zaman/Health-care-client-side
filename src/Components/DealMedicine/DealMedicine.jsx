...
const DealMedicine = () => {
  ...
  return (
    <div className="w-11/12 mx-auto my-6 px-8 bg-dealBg bg-center bg-no-repeat bg-cover lg:h-[500px] h-auto flex lg:flex-row flex-col gap-3 items-center">
      <div className="lg:w-1/2 w-full pl-8 space-y-3">
